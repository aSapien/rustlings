...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        let team_1_entry: &mut Team = scores.entry(team_1_name).or_insert(Team {goals_conceded: 0, goals_scored: 0});
        team_1_entry.goals_scored += team_1_score;
        team_1_entry.goals_conceded += team_2_score;

        let team_2_entry: &mut Team = scores.entry(team_2_name).or_insert(Team {goals_conceded: 0, goals_scored: 0});
